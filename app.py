...
[data-testid="stSidebar"] label { color: #6b7a99 !important; font-size: 0.72rem !important; font-weight: 600 !important; text-transform: uppercase !important; letter-spacing: 0.1em !important; }
[data-testid="stSidebar"] [data-testid="stSelectbox"] > div > div { background: #131929 !important; border: 1px solid rgba(255,255,255,0.07) !important; border-radius: 10px !important; color: #e0e8f5 !important; }

.stButton > button { background: linear-gradient(135deg, #f59e0b 0%, #ef4444 100%); color: #fff; font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 700; font-size: 0.95rem; letter-spacing: 0.04em; border: none; border-radius: 14px; padding: 0.85rem 1.5rem; width: 100%; cursor: pointer; box-shadow: 0 4px 24px rgba(245,158,11,0.25); transition: all 0.25s; }
.stButton > button:hover { transform: translateY(-2px); box-shadow: 0 8px 32px rgba(245,158,11,0.4); }
...
model, encoders, meta = load_assets()
...
<div class="hero-desc">
    ...
    trained on 24,000+ real listings across 25 Nigerian states using a
    Random Forest regression model with engineered features.
</div>
""", unsafe_allow_html=True)
...
<div class="stats-row">
    ...
    <div class="stat-card">
        ...
        <div class="stat-value" style="font-size:1rem;padding-top:0.3rem">Random Forest</div>
        <div class="stat-sub">regression</div>
    </div>
    <div class="stat-card">
...
| **Trees** | 100 (optimised for deployment size) |
...
<div style="text-align:center;color:#1e2740;font-size:0.78rem;margin-top:3rem;padding-bottom:1rem;">
    NaijaHousePrice AI · CSC 309 Mini Project · Random Forest + Streamlit
</div>""", unsafe_allow_html=True)
